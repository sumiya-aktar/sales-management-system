...
const Manageuser = () => {
  ...
  const loaderUser = async()=>{ 
    const result= await axios.get("http://localhost/sales-management-system/api-php/view.php");
    setUser(result.data.phpresult);
    console.log(result.data.phpresult);
  };

  const handleDelete= async(id)=>{
    const res= await axios.delete("http://localhost/sales-management-system/main/api-php/delete.php?id="+ id);
